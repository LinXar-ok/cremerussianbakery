      ...
      <div className="mt-16">
        <div className="border-b">
          <div className="flex space-x-8">
            <button className="py-4 border-b-2 border-red-600 text-red-600 font-semibold">
              Description
            </button>
            <button className="py-4 text-gray-600 hover:text-red-600 font-semibold">
              Ingredients
            </button>
            <button className="py-4 text-gray-600 hover:text-red-600 font-semibold">
        ...
        <div className="py-8">
          <div className="prose max-w-none">
            <h3 className="text-2xl font-bold mb-4">About This Cake</h3>
            ...
            <h4 className="text-xl font-bold mb-3">Allergens:</h4>
